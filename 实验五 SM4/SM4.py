...
FK = [0xa3b1bac6, 0x56aa3350, 0x677d9197, 0xb27022dc]#系统参数
CK = [
...
def encode(plaintext, rk):
    ...
    for i in range(32):
        ...
        c = (t ^ X[0])
        X = X[1:] + [c]
    ciphertext = R(X[0], X[1], X[2], X[3])# 进行反序处理
    return ciphertext

plaintext = 0x0123456789abcdeffedcba9876543210
main_key = 0x01010101010101010101010101010101
